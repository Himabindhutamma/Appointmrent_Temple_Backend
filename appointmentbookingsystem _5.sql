...
CREATE TABLE `organization` (
  ...
  KEY `organizationTypeId_fk_organization_idx` (`organizationTypeId`),
  CONSTRAINT `organizationTypeId_fk_organization` FOREIGN KEY (`organizationTypeId`) REFERENCES `organizationType` (`organizationTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-23 19:51:54
